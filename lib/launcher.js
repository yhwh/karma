...
var Launcher = function(emitter, injector) {
  ...
  this.launch.$inject = ['config.browsers', 'config.clientHost', 'config.clientPort', 'config.urlRoot'];
  ...
  this.getBrowserNameById = function(id) {
    return browsersNameMap[id];
  };
  // register events
